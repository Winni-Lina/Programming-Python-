...
# index1 = url[7:12]
# print(index1)
# pw = index1[:3]+str(len(index1))+str(index1.count('e'))+"!"
# print(pw)
...
# 댓글 작성자들 중에 추첨을 통해 1명은 치킨, 3ㅕㅇ은 커피 쿠폰을 받게됩니다.
# 추첨 프로그램을 작성하시오.
#
...
#출석 번호가 1 2 3 4, 앞에 100을 붙이기 함 -> 101, 102, 103, 104
...
#     print()
#
# profile("유재석", 20, "python", "Java", "C", "C++", "C#","JavaScri pt")
...
#     elif gender=="여자":
#         return round(height*height*23,2)
#     else:
#         print("여자또는 남자로 성별을 지정해주세요")
#         return 0
#
# gender="남자"
# height=175
# standar = standardWeight(height, gender)
# print("키 {0}cm {1}의 표준 체중은 {2}kg 입니다.".format(height,gender,standar))
...
#     print("{0} : {1} 방향으로 적국은 공격합니다. [공격력 {2}]".format(name, location, damage))
...
#
# #마인드 컨트롤: 상대방의 유닛을 내 것으로 만드는 것(빼앗음)
...
#             print("{0} : 파괴되었습니다.".format(self.name))
#
# # 드람쉽 : 공중 유닛, 수송기, 마린 /파이어뱃 / 탱크 등을 수송, 공격붉
# #날 수 있는 기능을 가진 클래스
# class Flyable:
...
# #배트 크루저 : 공중 유닛, 체력도 굉장히 좋음 공격력도 좋음.
...
#             else:
#                 print("{0} : 체력이 부족하여 스티맥을 사용하지 않습니다.".format(self.name))
#
# #탱크
# class Tank(AttackUnit):
#     #시즈모드는 탱크를 지상에 고정시켜, 더 높은 파워로 공격 가능. 이동불가
...
#9-12. 퀴즈 #8
# Quiz) 주인 코드를 활용하여 부동산 프로그램을 작성하시오.
#
# (출력 예제)
# 총 3대의 ㅁ물이 있습니다.
# 강남 아파트 매매 10억 2010년
...
# # import travel.thailand.ThaiandPackage
# trip_to = travel.thailand.ThaiandPackage()
# trip_to.detail()
